      ...
      >
        ...
        >
          <span className="text-[#000] dark:text-[white]">
            About <span className="text-[#155dfc]">ShopSphere</span>
          </span>
        </motion.h1>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 sm:text-base">
              ...
              ShopSphere stays ahead of the curve with practical, modern and
        ...
        >
          ...
          <p className="mb-6 text-sm text-gray-700 dark:text-gray-300 sm:text-base">
            Whether you’re a tech enthusiast or just exploring — ShopSphere
